...
%
 ...
 J         = 8.3;         % Recurrent synaptic coupling efficacy
 U         = 0.35;      % Probability of synaptic release 
 tau_rec   = 0.5;       % Depression recovery time constant [sec]
 tau_fac   = 0.001;     % Facilitation recovery time constant [sec]
...
print(gcf, '-depsc2', 'Figure5_panel_b.eps')
print(gcf, '-dpng', 'Figure5_panel_b.png')
